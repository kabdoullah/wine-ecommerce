...
export const metadata: Metadata = {
  ...
  description:
    'Découvrez notre sélection exceptionnelle de vins français et internationaux',
};
      ...
      <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-600 max-w-2xl mx-auto'>
            Une sélection rigoureuse de vins français et internationaux pour
            tous les palais et toutes les occasions.
          </p>
          ...
          <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3'>
            <div className='bg-white p-6 rounded-lg shadow-sm'>
              ...
              <p className='text-gray-600'>
                Des vins soigneusement sélectionnés par nos experts sommeliers.
              </p>
            </div>
            <div className='bg-white p-6 rounded-lg shadow-sm'>
              <div className='text-purple-600 text-3xl mb-4'>🚚</div>
            ...
            <div className='bg-white p-6 rounded-lg shadow-sm'>
              ...
              <p className='text-gray-600'>
                Conservation optimale et garantie de satisfaction ou remboursé.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
              ...
              <p className='text-gray-400 text-sm'>
                Votre caviste en ligne pour une sélection premium de vins
                d&apos;exception.
              </p>
            </div>
            <div>
